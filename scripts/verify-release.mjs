...
const requiredFiles = ['Dockerfile', '.env.example', 'config/schedule.json', 'docs/deployment.md', 'docs/production-checklist.md', 'src/price-history-provider.mjs', 'src/tpex-history-provider.mjs', 'src/batch-state.mjs', 'src/batch-worker.mjs', 'src/scan-coordinator.mjs', 'src/production-batch.mjs', 'src/universe-store.mjs', 'src/official-csv.mjs', 'src/api-contract.mjs', 'scripts/scan-batch.js', 'test/batch-worker.test.mjs', 'test/official-fetch-retry.test.mjs', 'test/universe-store.test.mjs', 'test/production-api.test.mjs'];
const missing = [];
